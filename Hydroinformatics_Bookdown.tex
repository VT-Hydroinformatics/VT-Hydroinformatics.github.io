...
## 3 1645423         0 1907-10-01 2021-03-14    32672
...
## 2 1645423         0 1907-10-01 2021-03-14    32672           Physical
...
## 1          ST   36.88873   -81.34733     FALSE 2021-03-15 10:04:26
## 2          ST   37.18428   -81.32982     FALSE 2021-03-15 10:04:26
## 3          ST   37.27151   -81.30482     FALSE 2021-03-15 10:04:26
## 4          ST   37.25595   -81.28177     FALSE 2021-03-15 10:04:26
## 5          ST   36.85984   -80.98036     FALSE 2021-03-15 10:04:26
## 6          ST   36.75985   -80.95619     FALSE 2021-03-15 10:04:26
## 7          ST   36.83485   -80.95258     FALSE 2021-03-15 10:04:26
## 8          SP   36.93429   -80.90313     FALSE 2021-03-15 10:04:26
## 9          ST   36.93095   -80.90036     FALSE 2021-03-15 10:04:26
## 10         SP   36.93068   -80.89619     FALSE 2021-03-15 10:04:26
## 11         ST   36.93901   -80.88730     FALSE 2021-03-15 10:04:26
## 12         ST   37.30568   -80.84980     FALSE 2021-03-15 10:04:26
## 13         ST   37.04734   -80.77618     FALSE 2021-03-15 10:04:26
## 14         ST   36.93762   -80.74563     FALSE 2021-03-15 10:04:26
## 15         ST   36.88901   -80.72757     FALSE 2021-03-15 10:04:26
## 16         ST   37.24179   -80.71090     FALSE 2021-03-15 10:04:26
## 17         ST   37.26818   -80.70951     FALSE 2021-03-15 10:04:26
## 18         ST   37.28957   -80.61673     FALSE 2021-03-15 10:04:26
## 19         ST   37.14179   -80.56922     FALSE 2021-03-15 10:04:26
## 20         ST   37.03763   -80.55672     FALSE 2021-03-15 10:04:26
## 21         ST   36.99652   -80.52144     FALSE 2021-03-15 10:04:26
\end{verbatim}
...
\begin{verbatim}
##   [1] "#"                                                                                                                                            
##   [2] "# File created on 2021-03-15 10:04:32 EDT"                                                                                                    
##   [3] "#"                                                                                                                                            
...
\hypertarget{htmlwidget-4c4e7a92b3e364727209}{}
...
\hypertarget{htmlwidget-e8342f4e53792494691c}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# brush \textless{}{-} raster("McDonaldHollowDEM/brushDEMsmall.tif")}
\CommentTok{\# }
\CommentTok{\# wbt\_resample("McDonaldHollowDEM/brushDEMsmall.tif",}
\CommentTok{\#              "McDonaldHollowDEM/brushDEMsm\_5m.tif",}
\CommentTok{\#              cell\_size = 0.00003925595)}
\CommentTok{\# }
\CommentTok{\# brush \textless{}{-} raster("McDonaldHollowDEM/brushDEMsm\_5m.tif")}
\CommentTok{\# }
\CommentTok{\# tm\_shape(brush)+}
\CommentTok{\#   tm\_raster(style = "cont", palette = "PuOr", legend.show = TRUE)+}
\CommentTok{\#   tm\_scale\_bar()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dem }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/brushDEMsm\_5m.tif"}\NormalTok{)}
...
\hypertarget{htmlwidget-a99477741e25f5b17d5d}{}

Hillshade for visualization

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_hillshade}\NormalTok{(}\StringTok{"McDonaldHollowDEM/brushDEMsm\_5m.tif"}\NormalTok{,}
              \StringTok{"McDonaldHollowDEM/brush\_hillshade.tif"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{htmlwidget-16d61e39fd7f26d9f0eb}{}

Prep DEM for hydro analysis

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_fill\_single\_cell\_pits}\NormalTok{(}\StringTok{"McDonaldHollowDEM/brushDEMsm\_5m.tif"}\NormalTok{,}
                     \StringTok{"McDonaldHollowDEM/bmstationdem\_filled.tif"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_breach\_depressions\_least\_cost}\NormalTok{(}\StringTok{"McDonaldHollowDEM/bmstationdem\_filled.tif"}\NormalTok{,}
                     \StringTok{"McDonaldHollowDEM/bmstationdem\_filled\_breached.tif"}\NormalTok{,}
...
\hypertarget{htmlwidget-c05b3c9eb5ec94772243}{}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_slope}\NormalTok{(}\StringTok{"McDonaldHollowDEM/brushDEMsm\_5m.tif"}\NormalTok{,}
...
\FunctionTok{tm\_shape}\NormalTok{(slope)}\SpecialCharTok{+}
  \FunctionTok{tm\_raster}\NormalTok{(}\AttributeTok{style =} \StringTok{"cont"}\NormalTok{, }\AttributeTok{palette =} \StringTok{"PuOr"}\NormalTok{, }\AttributeTok{legend.show =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{tm\_scale\_bar}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{htmlwidget-c0be0077199b1eb82c6e}{}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_d8\_flow\_accumulation}\NormalTok{(}\StringTok{"McDonaldHollowDEM/bmstationdem\_filled\_breached.tif"}\NormalTok{,}
                         \StringTok{"McDonaldHollowDEM/D8FA.tif"}\NormalTok{,}
...
\hypertarget{htmlwidget-5f4ab1558dbee7f06e7b}{}
...
\hypertarget{htmlwidget-dffb4aa376226a0523e6}{}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_wetness\_index}\NormalTok{(}\AttributeTok{sca =} \StringTok{"McDonaldHollowDEM/D8FA.tif"}\NormalTok{,}
...
\hypertarget{htmlwidget-9179bc2cf185ae4e1a4d}{}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_downslope\_index}\NormalTok{(}\StringTok{"McDonaldHollowDEM/brushDEMsm\_5m.tif"}\NormalTok{,}
                      \StringTok{"McDonaldHollowDEM/TWId.tif"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{htmlwidget-873cbc321da70d966f32}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d\_inf }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/D8FA.tif"}\NormalTok{)}

\FunctionTok{tm\_shape}\NormalTok{(}\FunctionTok{log}\NormalTok{(d\_inf))}\SpecialCharTok{+}
  \FunctionTok{tm\_raster}\NormalTok{(}\AttributeTok{style =} \StringTok{"cont"}\NormalTok{, }\AttributeTok{palette =} \StringTok{"PuOr"}\NormalTok{, }\AttributeTok{legend.show =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{tm\_scale\_bar}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{htmlwidget-bb890ff223b70ddfa7bf}{}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_extract\_streams}\NormalTok{(}\StringTok{"McDonaldHollowDEM/D8FA.tif"}\NormalTok{,}
                    \StringTok{"McDonaldHollowDEM/raster\_streams.tif"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_d8\_pointer}\NormalTok{(}\StringTok{"McDonaldHollowDEM/bmstationdem\_filled\_breached.tif"}\NormalTok{,}
               \StringTok{"McDonaldHollowDEM/D8pointer.tif"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_raster\_streams\_to\_vector}\NormalTok{(}\StringTok{"McDonaldHollowDEM/raster\_streams.tif"}\NormalTok{,}
                              \StringTok{"McDonaldHollowDEM/D8pointer.tif"}\NormalTok{,}
                              \StringTok{"McDonaldHollowDEM/streams.shp"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{htmlwidget-e2c970a11ff611c61e54}{}
