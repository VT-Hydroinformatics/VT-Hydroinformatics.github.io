...
\hypertarget{stats}{%
\chapter{Intro/Review of Basic Statistics}\label{stats}}
...
\hypertarget{intro-stats-activity}{%
\chapter{Intro Stats Activity}\label{intro-stats-activity}}
...
## 3 1645423         0 1907-10-01 2021-02-18    32648
...
The following images from from the R for Data Science book linked above (\url{https://r4ds.had.co.nz/relational-data.html})

Take for example the two data sets, x and y. The colored numbers are the key values and the x and y values are the data.

\includegraphics[width=2.42708in,height=\textheight]{images/join-setup2.png} source: \url{https://d33wubrfki0l68.cloudfront.net/108c0749d084c03103f8e1e8276c20e06357b124/5f113/diagrams/join-setup.png}

Note the 1 \& 2 keys match up, but 3 and 4 only exist in one data set or the other.

The first way to deal with this is an inner join: inner\_join() In an inner join, you only keep records that match. So the rows for 3 and 4 will be dropped because there is no corresponding data in the other set. See below:

\includegraphics[width=4.77083in,height=\textheight]{images/join-inner.png} source: \url{https://d33wubrfki0l68.cloudfront.net/3abea0b730526c3f053a3838953c35a0ccbe8980/7f29b/diagrams/join-inner.png})
...
\includegraphics[width=3.21875in,height=\textheight]{images/join-outer.png}source: \url{https://d33wubrfki0l68.cloudfront.net/9c12ca9e12ed26a7c5d2aa08e36d2ac4fb593f1e/79980/diagrams/join-outer.png}

The image above shows the three outer joins:
...
## 2 1645423         0 1907-10-01 2021-02-18    32648           Physical
...
## 1          ST   36.88873   -81.34733     FALSE 2021-02-19 11:17:12
## 2          ST   37.18428   -81.32982     FALSE 2021-02-19 11:17:12
## 3          ST   37.27151   -81.30482     FALSE 2021-02-19 11:17:12
## 4          ST   37.25595   -81.28177     FALSE 2021-02-19 11:17:12
## 5          ST   36.85984   -80.98036     FALSE 2021-02-19 11:17:12
## 6          ST   36.75985   -80.95619     FALSE 2021-02-19 11:17:12
## 7          ST   36.83485   -80.95258     FALSE 2021-02-19 11:17:12
## 8          SP   36.93429   -80.90313     FALSE 2021-02-19 11:17:12
## 9          ST   36.93095   -80.90036     FALSE 2021-02-19 11:17:12
## 10         SP   36.93068   -80.89619     FALSE 2021-02-19 11:17:12
## 11         ST   36.93901   -80.88730     FALSE 2021-02-19 11:17:12
## 12         ST   37.30568   -80.84980     FALSE 2021-02-19 11:17:12
## 13         ST   37.04734   -80.77618     FALSE 2021-02-19 11:17:12
## 14         ST   36.93762   -80.74563     FALSE 2021-02-19 11:17:12
## 15         ST   36.88901   -80.72757     FALSE 2021-02-19 11:17:12
## 16         ST   37.24179   -80.71090     FALSE 2021-02-19 11:17:12
## 17         ST   37.26818   -80.70951     FALSE 2021-02-19 11:17:12
## 18         ST   37.28957   -80.61673     FALSE 2021-02-19 11:17:12
## 19         ST   37.14179   -80.56922     FALSE 2021-02-19 11:17:12
## 20         ST   37.03763   -80.55672     FALSE 2021-02-19 11:17:12
## 21         ST   36.99652   -80.52144     FALSE 2021-02-19 11:17:12
\end{verbatim}
...
\includegraphics[width=5.79167in,height=\textheight]{images/longer.png} source: \url{https://d33wubrfki0l68.cloudfront.net/3aea19108d39606bbe49981acda07696c0c7fcd8/2de65/images/tidy-9.png}

\includegraphics[width=5.39583in,height=\textheight]{images/wider.png} source: \url{https://d33wubrfki0l68.cloudfront.net/8350f0dda414629b9d6c354f87acf5c5f722be43/bcb84/images/tidy-8.png}
...
\begin{verbatim}
##   [1] "#"                                                                                                                                            
##   [2] "# File created on 2021-02-19 11:17:18 EST"                                                                                                    
##   [3] "#"                                                                                                                                            
...
How can we look at the distribution of the flow data?

What is the median flow value?
What does this tell us about flow at that river? How often is the river at or below that value?
...
Let's look at an Empirical Cumulative Density Function (ECDF) of the data. What does this show?
...
P = 100 * {[}M / (n + 1){]}
P = Probability a flow is equalled or exceeded
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Can you make the ECDF plot look like this?}
\NormalTok{Qdat }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(Flow))}\SpecialCharTok{+}
  \FunctionTok{stat\_ecdf}\NormalTok{()}\SpecialCharTok{+}
...
It looked like the flow regime may have shifted a bit in the data. Let's use flow duratoin curves to examine potential differences. We can come up with groups and then use group\_by to run the analysis by groups instead of the whole dataset
...
Show change in flow regime from dam removal --09521000 Hoover dam closed 1936 changes big enough to see without logging

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{siteid }\OtherTok{\textless{}{-}} \StringTok{"12301933"}
\NormalTok{startDate }\OtherTok{\textless{}{-}} \StringTok{"1905{-}10{-}01"}
\NormalTok{endDate }\OtherTok{\textless{}{-}} \StringTok{"1965{-}01{-}01"}
\NormalTok{parameter }\OtherTok{\textless{}{-}} \StringTok{"00060"}

\NormalTok{WS }\OtherTok{\textless{}{-}} \FunctionTok{readNWISdv}\NormalTok{(siteid, parameter)}\SpecialCharTok{\%\textgreater{}\%}\CommentTok{\#, startDate, endDate) \%\textgreater{}\% }
...
\NormalTok{flow }\SpecialCharTok{/}\NormalTok{ (fdc }\SpecialCharTok{+}\NormalTok{ fdc)}
\end{Highlighting}
\end{Shaded}
...
Analysis based on: \url{https://github.com/DEQdsobota/Oregon7Q10/blob/master/R/Oregon7Q10.R} And: \url{https://nepis.epa.gov/Exe/ZyPDF.cgi?Dockey=P100BK6P.txt}
...
\includegraphics{Hydroinformatics_Bookdown_files/figure-latex/unnamed-chunk-96-1.pdf}
...
\includegraphics{Hydroinformatics_Bookdown_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\includegraphics{Hydroinformatics_Bookdown_files/figure-latex/unnamed-chunk-106-1.pdf}
