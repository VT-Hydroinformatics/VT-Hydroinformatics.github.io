...
## 1          ST   36.88873   -81.34733     FALSE 2021-03-23 15:08:11
## 2          ST   37.18428   -81.32982     FALSE 2021-03-23 15:08:11
## 3          ST   37.27151   -81.30482     FALSE 2021-03-23 15:08:11
## 4          ST   37.25595   -81.28177     FALSE 2021-03-23 15:08:11
## 5          ST   36.85984   -80.98036     FALSE 2021-03-23 15:08:11
## 6          ST   36.75985   -80.95619     FALSE 2021-03-23 15:08:11
## 7          ST   36.83485   -80.95258     FALSE 2021-03-23 15:08:11
## 8          SP   36.93429   -80.90313     FALSE 2021-03-23 15:08:11
## 9          ST   36.93095   -80.90036     FALSE 2021-03-23 15:08:11
## 10         SP   36.93068   -80.89619     FALSE 2021-03-23 15:08:11
## 11         ST   36.93901   -80.88730     FALSE 2021-03-23 15:08:11
## 12         ST   37.30568   -80.84980     FALSE 2021-03-23 15:08:11
## 13         ST   37.04734   -80.77618     FALSE 2021-03-23 15:08:11
## 14         ST   36.93762   -80.74563     FALSE 2021-03-23 15:08:11
## 15         ST   36.88901   -80.72757     FALSE 2021-03-23 15:08:11
## 16         ST   37.24179   -80.71090     FALSE 2021-03-23 15:08:11
## 17         ST   37.26818   -80.70951     FALSE 2021-03-23 15:08:11
## 18         ST   37.28957   -80.61673     FALSE 2021-03-23 15:08:11
## 19         ST   37.14179   -80.56922     FALSE 2021-03-23 15:08:11
## 20         ST   37.03763   -80.55672     FALSE 2021-03-23 15:08:11
## 21         ST   36.99652   -80.52144     FALSE 2021-03-23 15:08:11
\end{verbatim}
...
\begin{verbatim}
##   [1] "#"                                                                                                                                            
##   [2] "# File created on 2021-03-23 15:08:16 EDT"                                                                                                    
##   [3] "#"                                                                                                                                            
...
\hypertarget{htmlwidget-e626613ed4570a6f9cf8}{}
...
\hypertarget{htmlwidget-df8fe0446c9f3cd3b516}{}
...
\hypertarget{htmlwidget-5a8d09f2650ce2f6615b}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wbt\_hillshade}\NormalTok{(}\AttributeTok{dem =} \StringTok{"McDonaldHollowDEM/brushDEMsm\_5m.tif"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hillshade }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/brush\_hillshade.tif"}\NormalTok{, }\AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
...
\hypertarget{htmlwidget-29e0b1f3cee6df7f9ab0}{}
...
\FunctionTok{wbt\_fill\_single\_cell\_pits}\NormalTok{(}
                    \AttributeTok{dem =} \StringTok{"McDonaldHollowDEM/brushDEMsm\_5m.tif"}\NormalTok{,}
...
\NormalTok{filled\_breached }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/bmstationdem\_filled\_breached.tif"}\NormalTok{,}
                          \AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
...
\hypertarget{htmlwidget-4c46ee36df5593bc9c1c}{}
...
\begin{verbatim}
## [1] "d8_flow_accumulation - Elapsed Time (excluding I/O): 0.26s"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d8 }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/D8FA.tif"}\NormalTok{, }\AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
...
\hypertarget{htmlwidget-f02e5e085363c3a95a49}{}
...
\begin{verbatim}
## [1] "d_inf_flow_accumulation - Elapsed Time (excluding I/O): 0.39s"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dinf }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/DinfFA.tif"}\NormalTok{, }\AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
...
\hypertarget{htmlwidget-1a44aaca8e9511257027}{}
...
\begin{verbatim}
## [1] "d_inf_flow_accumulation - Elapsed Time (excluding I/O): 0.35s"
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{twi }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/TWI.tif"}\NormalTok{, }\AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
...
\hypertarget{htmlwidget-baf006d5b9ff6b31a889}{}
...
\begin{verbatim}
## [1] "downslope_index - Elapsed Time (excluding I/O): 0.9s"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{twid }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/TWId.tif"}\NormalTok{, }\AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
...
\hypertarget{htmlwidget-146adb7a91b76b0b0337}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{streams }\OtherTok{\textless{}{-}} \FunctionTok{st\_read}\NormalTok{(}\StringTok{"McDonaldHollowDEM/streams.shp"}\NormalTok{, }\AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{htmlwidget-368d45f6d4af5c971d06}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{slope }\OtherTok{\textless{}{-}} \FunctionTok{raster}\NormalTok{(}\StringTok{"McDonaldHollowDEM/demslope.tif"}\NormalTok{, }\AttributeTok{crs =} \StringTok{\textquotesingle{}+init=EPSG:4326\textquotesingle{}}\NormalTok{)}
...
\begin{verbatim}
## [1] "hillshade - Elapsed Time (excluding I/O): 0.10s"
\end{verbatim}
...
\begin{verbatim}
## [1] "breach_depressions_least_cost - Elapsed Time (excluding I/O): 0.56s"
\end{verbatim}
...
\hypertarget{htmlwidget-6b1f7f58842aa469aa15}{}
...
\begin{verbatim}
## [1] "watershed - Elapsed Time (excluding I/O): 0.15s"
\end{verbatim}
...
\hypertarget{htmlwidget-ec051a521c6f69a4ab90}{}
...
\NormalTok{ws1shp }\OtherTok{\textless{}{-}}\NormalTok{ wsshape }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(brush\_watersheds.tif }\SpecialCharTok{==} \StringTok{"1"}\NormalTok{)}
...
\hypertarget{htmlwidget-65a032004b25b4334251}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ws1\_bound }\OtherTok{\textless{}{-}} \FunctionTok{filter}\NormalTok{(wsshape, brush\_watersheds.tif }\SpecialCharTok{==} \StringTok{"1"}\NormalTok{)}
